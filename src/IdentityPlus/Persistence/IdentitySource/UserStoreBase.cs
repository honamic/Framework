...
namespace Honamic.IdentityPlus.Persistence.IdentitySource;
    ...
    where TUserToken : UserToken, new()
{
    ...
    /// <summary>
    /// Called to create a new instance of a <see cref="IdentityUserClaim{long}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Called to create a new instance of a <see cref="IdentityUserLogin{long}"/>.
    /// </summary>
    /// <param name="user">The associated user.</param>
    ...
    /// <summary>
    /// Called to create a new instance of a <see cref="IdentityUserToken{long}"/>.
    /// </summary>
    /// <param name="user">The associated user.</param>
    ...
    /// <returns>An instance of <typeparamref name="long"/> representing the provided <paramref name="id"/>.</returns>
    [UnconditionalSuppressMessage("Trimming", "IL2026:Members annotated with 'RequiresUnreferencedCodeAttribute' require dynamic access otherwise can break functionality when trimming application code",
        Justification = "long is annoated with RequiresUnreferencedCodeAttribute.All.")]
    ...
    protected abstract Task<TUserLogin?> FindUserLoginAsync(long userId, string loginProvider, string providerKey, CancellationToken cancellationToken);
...
/// <typeparam name="long">The type of the primary key for a role.</typeparam>
/// <typeparam name="TUserClaim">The type representing a claim.</typeparam>
    ...
    where TRoleClaim : RoleClaim, new()
{
    ...
    /// <summary>
    /// Called to create a new instance of a <see cref="IdentityUserRole{long}"/>.
    /// </summary>
    /// <param name="user">The associated user.</param>
